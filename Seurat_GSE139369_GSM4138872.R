...
#Import the data
study4_RNA <- readRDS(paste0(outputLoc, "GSE139369/GSM4138872_scRNA_BMMC_D1T1.rds"))
study4_protein <- readRDS(paste0(outputLoc, "GSE139369/GSM4138872_scADT_BMMC_D1T1.rds"))
...
all.equal(colnames(study4_RNA), colnames(study4_protein))
...
saveRDS(study4, paste0(outputLoc, "SeuratObjects/seuratObj_GSE139369_GSM4138872.rda"))
