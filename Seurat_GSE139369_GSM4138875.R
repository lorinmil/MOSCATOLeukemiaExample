...
#Import the data
study4_RNA <- readRDS(paste0(outputLoc, "GSE139369/GSM4138875_scRNA_CD34_D3T1.rds"))
study4_protein <- readRDS(paste0(outputLoc, "GSE139369/GSM4138875_scADT_CD34_D3T1.rds"))
...
saveRDS(study4, paste0(outputLoc, "SeuratObjects/seuratObj_GSE139369_GSM4138875.rda"))
