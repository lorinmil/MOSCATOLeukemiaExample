...
#Import the data
study4_RNA <- readRDS(paste0(outputLoc, "GSE139369/GSM4138881_scRNA_MPAL3_T1.rds"))
study4_protein <- readRDS(paste0(outputLoc, "GSE139369/GSM4138881_scADT_MPAL3_T1.rds"))
...
saveRDS(study4, paste0(outputLoc, "SeuratObjects/seuratObj_GSE139369_GSM4138881.rda"))
