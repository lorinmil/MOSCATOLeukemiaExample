...
study2_RNA <- study2_RNA[, (colnames(study2_RNA) %in% study2_cellAnnotations$X[study2_cellAnnotations$HTO_Barcodes=="Baseline"]) & 
                           (colnames(study2_RNA) %in% study2_cellAnnotations$X[study2_cellAnnotations$Donor_of_Origin==donors[3]])]
...
study2_protein <- study2_protein[, (colnames(study2_protein) %in% study2_cellAnnotations$X[study2_cellAnnotations$HTO_Barcodes=="Baseline"]) & 
                                   (colnames(study2_protein) %in% study2_cellAnnotations$X[study2_cellAnnotations$Donor_of_Origin==donors[3]])]
...
saveRDS(study2, paste0(outputLoc, "SeuratObjects/seuratObj_ERP124005_subject3.rda"))
