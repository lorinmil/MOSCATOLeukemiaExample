...
#Import the data
study4_RNA <- readRDS(paste0(outputLoc, "GSE139369/GSM4138879_scRNA_MPAL1_T2.rds"))
study4_protein <- readRDS(paste0(outputLoc, "GSE139369/GSM4138879_scADT_MPAL1_T2.rds"))
...
saveRDS(study4, paste0(outputLoc, "SeuratObjects/seuratObj_GSE139369_GSM4138879.rda"))
