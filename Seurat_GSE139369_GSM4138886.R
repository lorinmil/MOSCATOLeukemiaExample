...
#Import the data
study4_RNA <- readRDS(paste0(outputLoc, "GSE139369/GSM4138886_scRNA_MPAL5R_T1.rds"))
study4_protein <- readRDS(paste0(outputLoc, "GSE139369/GSM4138886_scADT_MPAL5R_T1.rds"))
...
all.equal(colnames(study4_RNA), colnames(study4_protein)) #TRUE
...
saveRDS(study4, paste0(outputLoc, "SeuratObjects/seuratObj_GSE139369_GSM4138886.rda"))
